...
wget -q -O /etc/slowdns/server.key "https://gitea.com/alfalemos/SSHPLUS/raw/main/Modulos/server.key"
wget -q -O /etc/slowdns/server.pub "https://gitea.com/alfalemos/SSHPLUS/raw/main/Modulos/server.pub"
