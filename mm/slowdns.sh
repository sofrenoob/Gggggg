...
read -rp "domínio: " -e domain
 
read -rp "Subdomínio: " -e sub
...
wget -q -O /etc/slowdns/server.key "https://raw.githubusercontent.com/kiritosshxd/SSHPLUS/main/Slowdns/server.key"
wget -q -O /etc/slowdns/server.pub "https://raw.githubusercontent.com/kiritosshxd/SSHPLUS/main/Slowdns/server.pub"
