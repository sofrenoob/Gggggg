...
# Vivo - 7001
screen -dmS vivo socat TCP4-LISTEN:7001,reuseaddr,fork TCP4:127.0.0.1:1194
echo -e "\e[1;36m[+] Vivo túnel ativo na porta 7001\e[0m"

# Claro - 7002
screen -dmS claro socat TCP4-LISTEN:7002,reuseaddr,fork TCP4:127.0.0.1:1195
echo -e "\e[1;36m[+] Claro túnel ativo na porta 7002\e[0m"

# Tim - 7003
screen -dmS tim socat TCP4-LISTEN:7003,reuseaddr,fork TCP4:127.0.0.1:1196
